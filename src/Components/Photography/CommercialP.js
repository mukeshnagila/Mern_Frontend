    ...
    return(
        <>
            ...
            <div className="Communication">
                ...
                <h1 className="Communication_H1">All Commerical Photography Courses</h1>
                ...
                <div className="mostpopular">
                    ...
                    {Sdata.filter((item) => item.subcategory === "commerical_P").map((item, index) => {
                            return(
                                <>                        
