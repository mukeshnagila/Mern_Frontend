    ...
    return(
        <>
            <div className="Nav2nd">
                ...
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/LifeStyle/Arts_S">Arts & Crafts</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/LifeStyle/Beauty_S">Beauty & Makeup</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/LifeStyle/Food_S">Food & Beverage</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/LifeStyle/Pet_S">Pet Care & Training</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/LifeStyle/Travel_S">Travel</NavLink></p>
            </div>

            <div className="Communication">
                
                <h1 className="Communication_H1">All Life Style Courses</h1>
                ...
                <div className="mostpopular">
                    ...
                    {Sdata.filter((item) => item.category === "LifeStyle" && item.id % 7 === 0).map((item, index) => {
                            return(
                                <>                        
            ...
            <div className="Business_last_sec">
                    <div className="forBLast">
                            ...
                            {Sdata.filter((item) => item.category === "LifeStyle" && item.id % 8 === 0).map((item, index) => {
                            return(
                                <>
