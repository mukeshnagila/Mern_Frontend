    ...
    return(
        <>
            ...
            <div className="Communication">
                ...
                <h1 className="Communication_H1">All Academic Social Science Courses</h1>
                ...
                <div className="mostpopular">
                    ...
                    {Sdata.filter((item) => item.subcategory === "social_T").map((item, index) => {
                            return(
                                <>                        
