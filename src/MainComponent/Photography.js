    ...
    return(
        <>
            <div className="Nav2nd">
                ...
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Photography/Digital_p">Digital Photography</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Photography/Photo_p">Photography</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Photography/Video_p">Video Design</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Photography/Commercial_p">Commercial Photography</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Photography/Ptool_p">Photography Tools</NavLink></p>
            </div>

            <div className="Communication">
                
                <h1 className="Communication_H1">All Photography Courses</h1>
                ...
                <div className="mostpopular">
                    ...
                    {Sdata.filter((item) => item.category === "Photography" && item.id % 7 === 0).map((item, index) => {
                            return(
                                <>                        
                ...
                <hr/>
                        <div className="ASchild1">
                                <div className="ASmini">
                                    <img className="ASmini_img" src="https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcTJRacqYivS-UjxhOO4UPc3f3ryzORPIDByID2o7We26oiIEp5H" alt="BusinessImage" />
                                    <h2 className="ASmini_H2">Learn in-demand skills with over 210,000 video courses</h2>
                                </div>

                                <div className="ASmini">
                                    <img className="ASmini_img" src="https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcTYLtySaxciI_EyNE3L5_LsDe8iUpXkykWl46N_faJqYhza_hmX" alt="BusinessImage" />
                                    <h2 className="ASmini_H2">Choose courses taught by real-world experts</h2>
                                </div>

                                <div className="ASmini">
                                    <img className="ASmini_img" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQTYkKsByAwOOOEo961Xlhj0Q87RgLIWJZCIP6omGLekWRLTFLH" alt="BusinessImage" />
            ...
            <div className="popular_Ins">
                ...
                <div className="popular_Ins_item">
                        <div className="Ins_item_1">
                                <img className="Ins_item_1_Img" src="https://img-c.udemycdn.com/user/75x75/2565950_892c_2.jpg" alt="Businessimage" />
                        ...
                        <div className="Ins_item_1">
                                <img className="Ins_item_1_Img" src="https://img-c.udemycdn.com/user/75x75/22101060_9158_2.jpg" alt="Businessimage" />
                                <div className="Ins_mini_item">
                                    <h3>Jessica Brody</h3>
                        ...
                        <div className="Ins_item_1">
                                <img className="Ins_item_1_Img" src="https://img-c.udemycdn.com/user/75x75/1681918_d7a1_7.jpg" alt="Businessimage" />
                                <div className="Ins_mini_item">
                                    <h3>Shani Raja</h3>
                        ...
                        <div className="Ins_item_1">
                                <img className="Ins_item_1_Img" src="	https://img-c.udemycdn.com/user/75x75/14942868_3ed6_38.jpg" alt="Businessimage" />
                                <div className="Ins_mini_item">
                                    <h3>TJ Walker</h3>
            ...
            <div className="allCcource">
                ...
                <div className="fornotsure">
                    <img className="fornotsureImg" src="https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcRSK4XX5P0UrM-P8ULiT516j5e8Di-dH32AfbdEe7pHsqAPP0tB" alt="Businessimage" />
            ...
            <div className="Business_last_sec">
                    <div className="forBLast">
                            ...
                            {Sdata.filter((item) => item.category === "Photography" && item.id % 8 === 0).map((item, index) => {
                            return(
                                <>
