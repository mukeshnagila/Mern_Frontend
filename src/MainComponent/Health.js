    ...
    return(
        <>
            <div className="Nav2nd">
                ...
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Health/Fitness_h">Fitness</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Health/Sport_h">Sport</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Health/Yoga_h">Yoga</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Health/Mhealth_h">Mental Health</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Health/Dance_h">Dance</NavLink></p>
            </div>

            <div className="Communication">
                
                <h1 className="Communication_H1">All Health & Fitness Courses</h1>
                ...
                <div className="mostpopular">
                    ...
                    {Sdata.filter((item) => item.category === "Health" && item.id % 7 === 0).map((item, index) => {
                            return(
                                <>                        
            ...
            <div className="Business_last_sec">
                    <div className="forBLast">
                            ...
                            {Sdata.filter((item) => item.category === "Health" && item.id % 8 === 0).map((item, index) => {
                            return(
                                <>
