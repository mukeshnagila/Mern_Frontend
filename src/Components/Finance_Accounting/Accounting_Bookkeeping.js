    ...
    return(
        <>
            <div className="Nav2nd">
                <h3>Finance_Accounting</h3>
                <img className="Nav2nd_img" src="https://s.udemycdn.com/browse_components/link-bar/large-next.svg" alt="sign" />
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Finance_Accounting/Accounting_Bookkeeping">Accounting_Bookkeeping</NavLink></p>
            ...
            <div className="Communication">
                ...
                <h1 className="Communication_H1">Accounting and Bookkeeping Courses</h1>
                ...
                <div className="mostpopular">
                    ...
                    {Sdata.filter((item) => item.subcategory === "Accounting_Bookkeeping").map((item, index) => {
                            return(
                                <>                        
