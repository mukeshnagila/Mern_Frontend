    ...
    return(
        <>
            <div className="Nav2nd">
                ...
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Music/Instruments_m">Instruments</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Music/Music_m">Music Production</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Music/Vocal_m">Vocal</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Music/Msoftware_m">Music Software</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Music/Mtechniqe_m">Music Techniques</NavLink></p>
            </div>

            <div className="Communication">
                
                <h1 className="Communication_H1">All Music Courses</h1>
                ...
                <div className="mostpopular">
                    ...
                    {Sdata.filter((item) => item.category === "Music" && item.id % 7 === 0).map((item, index) => {
                            return(
                                <>                        
            ...
            <div className="Business_last_sec">
                    <div className="forBLast">
                            ...
                            {Sdata.filter((item) => item.category === "Music" && item.id % 8 === 0).map((item, index) => {
                            return(
                                <>
