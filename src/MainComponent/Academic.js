    ...
    return(
        <>
            <div className="Nav2nd">
                <h3>Teaching & Academic</h3>
                <img className="Nav2nd_img" src="https://s.udemycdn.com/browse_components/link-bar/large-next.svg" alt="sign" />
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Academic/Engineering_T">Engineering</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Academic/Math_T">Math</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Academic/Science_T">Science</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Academic/SScience_T">Social Science</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Academic/Training_T">Teacher Training</NavLink></p>
            </div>

            <div className="Communication">
                
                <h1 className="Communication_H1">All Teaching & Academic Courses</h1>
                ...
                <div className="mostpopular">
                    ...
                    {Sdata.filter((item) => item.category === "Academic" && item.id % 7 === 0).map((item, index) => {
                            return(
                                <>                        
            ...
            <div className="Business_last_sec">
                    <div className="forBLast">
                            ...
                            {Sdata.filter((item) => item.category === "Academic" && item.id % 8 === 0).map((item, index) => {
                            return(
                                <>
