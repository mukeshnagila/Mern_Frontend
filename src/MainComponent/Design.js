    ...
    return(
        <>
            <div className="Nav2nd">
                ...
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Desine/web_D">Web Design</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Desine/game_D">Game Design</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Desine/animation_D">3D & Animation</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Desine/fashion_D">Fashion Design</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Desine/other_D">Other Design</NavLink></p>
            </div>

            <div className="Communication">
                
                <h1 className="Communication_H1">All Desine Courses</h1>
                ...
                <div className="mostpopular">
                    ...
                    {Sdata.filter((item) => item.category === "Desine" && item.id % 7 === 0).map((item, index) => {
                            return(
                                <>                        
            ...
            <div className="Business_last_sec">
                    <div className="forBLast">
                            ...
                            {Sdata.filter((item) => item.category === "Desine" && item.id % 8 === 0).map((item, index) => {
                            return(
                                <>
