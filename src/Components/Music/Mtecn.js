    ...
    return(
        <>
            ...
            <div className="Communication">
                ...
                <h1 className="Communication_H1">All Technique of Instrument Courses</h1>
                ...
                <div className="mostpopular">
                    ...
                    {Sdata.filter((item) => item.subcategory === "mtechnique_A").map((item, index) => {
                            return(
                                <>                        
