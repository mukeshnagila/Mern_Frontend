    ...
    return(
        <>
            ...
            <div className="Communication">
                ...
                <h1 className="Communication_H1">Operations Courses</h1>
                ...
                <div className="mostpopular">
                    ...
                    <div className="mostpopcontent">
                                ...
                                <div className="Startmostpop_item">
                                    <img className="Startmostpop_item_Img" src="https://img-c.udemycdn.com/course/240x135/14284_6833_17.jpg" alt="Operationsimage" />
                ...
                <hr/>
                        <div className="ASchild1">
                                <div className="ASmini">
                                    <img className="ASmini_img" src="https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcTJRacqYivS-UjxhOO4UPc3f3ryzORPIDByID2o7We26oiIEp5H" alt="OperationsImage" />
                                    <h2 className="ASmini_H2">Learn in-demand skills with over 210,000 video courses</h2>
                                </div>

                                <div className="ASmini">
                                    <img className="ASmini_img" src="https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcTYLtySaxciI_EyNE3L5_LsDe8iUpXkykWl46N_faJqYhza_hmX" alt="OperationsImage" />
                                    <h2 className="ASmini_H2">Choose courses taught by real-world experts</h2>
                                </div>

                                <div className="ASmini">
                                    <img className="ASmini_img" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQTYkKsByAwOOOEo961Xlhj0Q87RgLIWJZCIP6omGLekWRLTFLH" alt="OperationsImage" />
            ...
            <div className="PopularSec">
                    ...
                    <div className="popular_topic">
                            <button className="popular_topic_Btn">Supply Chain</button>
                            <button className="popular_topic_Btn">Logistics Management</button>
                            <button className="popular_topic_Btn">Lean</button>
                            <button className="popular_topic_Btn">Quality Management</button>
                            <button className="popular_topic_Btn">Six Sigma</button>
                            <button className="popular_topic_Btn">Lean Six Sigma Green Belt</button>
                            <button className="popular_topic_Btn">Lean Six Sigma Green Belt</button>
                            <button className="popular_topic_Btn">Vartual Assistant Skills</button>
                            <button className="popular_topic_Btn">Operations Management</button>
                            <button className="popular_topic_Btn">Certified Quality Engineer (CQE)</button>
                    </div>
            </div>
            ...
            <div className="popular_Ins">
                ...
                <div className="popular_Ins_item">
                        <div className="Ins_item_1">
                                <img className="Ins_item_1_Img" src="https://img-c.udemycdn.com/user/75x75/2565950_892c_2.jpg" alt="Operationsimage" />
                        ...
                        <div className="Ins_item_1">
                                <img className="Ins_item_1_Img" src="https://img-c.udemycdn.com/user/75x75/22101060_9158_2.jpg" alt="Operationsimage" />
                                <div className="Ins_mini_item">
                                    <h3>Jessica Brody</h3>
                        ...
                        <div className="Ins_item_1">
                                <img className="Ins_item_1_Img" src="https://img-c.udemycdn.com/user/75x75/1681918_d7a1_7.jpg" alt="Operationsimage" />
                                <div className="Ins_mini_item">
                                    <h3>Shani Raja</h3>
                        ...
                        <div className="Ins_item_1">
                                <img className="Ins_item_1_Img" src="	https://img-c.udemycdn.com/user/75x75/14942868_3ed6_38.jpg" alt="Operationsimage" />
                                <div className="Ins_mini_item">
                                    <h3>TJ Walker</h3>
            ...
            <div className="allCcource">
                ...
                <div className="fornotsure">
                    <img className="fornotsureImg" src="https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcRSK4XX5P0UrM-P8ULiT516j5e8Di-dH32AfbdEe7pHsqAPP0tB" alt="Operationsimage" />
                            ...
                            <div className="forBLast_content">
                                <div className="forBLast_content_item">
                                    <div className="forBLast_content_item1">
                                            <img className="forBLast_content_item1_Img" src="https://img-c.udemycdn.com/course/240x135/1355610_375a_5.jpg" alt="Operationsimage" />
                                    </div>
