    ...
    return(
        <>
            ...
            <div className="Communication">
                ...
                <h1 className="Communication_H1">IT Certification Courses</h1>
                ...
                <div className="mostpopular">
                    ...
                    {Sdata.filter((item) => item.subcategory === "IT_Certification").map((item, index) => {
                            return(
                                <>                        
...
export default IT_Certification;