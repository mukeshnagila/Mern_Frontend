    ...
    return(
        <>
            <div className="Nav2nd">
                ...
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Marketing/Digital_M">Digital Marketing</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Marketing/Media_M">Social Media Marketing</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Marketing/Public_M">Public Relationship</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Marketing/Content_M">Content Marketing</NavLink></p>
                <p className="Nav2nd_P"><NavLink className="Nav2nd_P2" to="/Marketing/Product_M">Product Marketing</NavLink></p>
            </div>

            <div className="Communication">
                
                <h1 className="Communication_H1">All Marketing Courses</h1>
                ...
                <div className="mostpopular">
                    ...
                    {Sdata.filter((item) => item.category === "Marketing" && item.id % 7 === 0).map((item, index) => {
                            return(
                                <>                        
            ...
            <div className="Business_last_sec">
                    <div className="forBLast">
                            ...
                            {Sdata.filter((item) => item.category === "Marketing" && item.id % 8 === 0).map((item, index) => {
                            return(
                                <>
